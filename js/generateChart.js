...
export const generateChart = (data) => {
  ...
  myChart = new Chart(ctx, {
    ...
    data: {
      labels: chartLabel,
      datasets:[
        {label: "Доходы", data: incomeAmounts, borderWidht: 2,  hidden: true }, 
        {label: "Расходы", data: expensesAmounts, borderWidht: 2,  hidden: true }, 
        {label: "Баланс", data: balanceAmounts, borderWidht: 2,  hidden: false },
      ],
    },
    options: {
      scales:  {
